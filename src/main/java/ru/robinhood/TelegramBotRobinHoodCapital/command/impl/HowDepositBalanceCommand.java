...
public class HowDepositBalanceCommand implements Command {
    ...
    public void execute(Message message) {
        String response = """
                ...
                Переведите на указанные реквизиты TON <b>и укажите в комментарии к платежу ваш код</b>. Если вы забудете указать код, то деньги не поступят к вам на счет.
                
                Код можно отправить отдельным сообщением, чтобы его легче было скопировать, для этого нажмите кнопку "<b>Отправить код</b>".
                
                После того как мы получим перевод, мы начислим USD по актуальному курсу на ваш счет. Обычно это занимает около 2-х минут.
                
                ⚠️<b>ВНИМАНИЕ</b>⚠️
                Переводить нужно TON, иначе средства будут безвозвратно утеряны!""".formatted(MenuCommand.FAQ);
