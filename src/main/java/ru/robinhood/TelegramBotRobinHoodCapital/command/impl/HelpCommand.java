...
public class HelpCommand implements Command {
    ...
    public void execute(Message message) {
        ...
        String response = """
                ...
                Так же вы можете посмотреть развел FAQ, возможно вы сможете найти ответ на ваш вопрос.
                
                Если вы желаете сменить адрес кошелька, то укажите причину, мы обработаем ее как можно быстрее.""";
