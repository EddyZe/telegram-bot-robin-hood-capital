...
public class HowLingWalletCommand implements Command {
    ...
    public void execute(Message message) {
        String response = """
                ...
                Чтобы привязать кошелек нужно перейти в раздел "<b>Личный кабинет - Управление счетом - Привязать кошелек</b>", после введите адрес вашего TON кошелька.
                
                Если вы ввели не верный адрес, то вы можете подать заявку на смену адреса кошелька.
                
                ⚠️<b>ВНИМАНИЕ</b>⚠️
                Вводите TON кошелек. Он нужен нам для того, чтобы вы смогли выводить средства.
